        ...
        <div className={`max-w-4xl mx-auto transition-all duration-1000 ${
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground text-lg">
              Thank you for choosing Scrum Master Hub. Your session has been successfully booked.
            </p>
          </div>
            ...
            <Card className="shadow-elegant">
              ...
              <CardContent className="space-y-3">
                ...
                <p className="text-sm text-muted-foreground mt-3">
                  Please join promptly at the start time. Preparation materials will be sent via email.
                </p>
              </CardContent>
            </Card>
          </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span>support@scrummasterhub.com</span>
                  </div>
                </div>
                <p className="text-sm text-muted-foreground mt-3">
